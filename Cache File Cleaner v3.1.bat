...
echo.
IF NOT EXIST "..\..\hl2.exe" (goto :ADDON_FOLDER_CONFIRM)
goto :CLEAN
...
echo.
echo.
call :colorPrint 0F "Cache File Cleaner has detected that you're running this file outside of custom folder."
echo.
echo.
call :colorPrint 0F "Removing cache files outside of custom folder can make the program unstable."
echo.
echo.
